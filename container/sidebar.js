...
export default function Header() {
    return (
<>
<aside  className="flex flex-col absolute left-0 top-0 lg:static lg:translate-x-0 bg-black dark:bg-boxdark w-72.5 ease-linear duration-300 z-9999 h-screen overflow-y-hidden">
        {/* SIDEBAR HEADER */}
        ...
        {/* SIDEBAR HEADER */}
        <div className="flex flex-col overflow-y-auto no-scrollbar ease-linear duration-300">
          {/* Sidebar Menu */}
          <nav className="py-4 px-4 lg:px-6 mt-5 lg:mt-9">
            {/* Menu Group */}
            <div>
              <h3 className="font-semibold text-sm text-bodydark2 mb-4 ml-4">MENU</h3>
              <ul className="flex flex-col gap-1.5 mb-6">
                {/* Menu Item Dashboard */}
                <li>
                  <Link className="group relative font-medium flex items-center gap-2.5 rounded-sm ease-in-out duration-300 py-2 px-4 text-bodydark1 hover:bg-graydark dark:hover:bg-meta-4" href="#">
                    ...
                    Dashboard
                    <svg className="fill-current absolute right-4 top-1/2 -translate-y-1/2" width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="overflow-hidden">
                    <ul className="flex flex-col gap-2.5 pl-6 mt-4 mb-5.5">
                      <li>
                        <Link className="group relative font-medium flex items-center gap-2.5 rounded-md ease-in-out duration-300 px-4 text-bodydark2 hover:text-white" href="index.html" >Analytics</Link>
                      </li>
                    </ul>
                  </div>
                  {/* Dropdown Menu End */}
                ...
                {/* Menu Item Calendar */}
                <li>
                  <Link className="group relative font-medium flex items-center gap-2.5 rounded-sm ease-in-out duration-300 py-2 px-4 text-bodydark1 hover:bg-graydark dark:hover:bg-meta-4" href="calendar.html" >
                    <svg className="fill-current" width={18} height={18} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Menu Item Profile */}
                <li>
                  <Link className="group relative font-medium flex items-center gap-2.5 rounded-sm ease-in-out duration-300 py-2 px-4 text-bodydark1 hover:bg-graydark dark:hover:bg-meta-4" href="profile.html">
                    <svg className="fill-current" width={18} height={18} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                  ...
                  <div className="overflow-hidden">
                    <ul className="flex flex-col gap-2.5 pl-6 mt-4 mb-5.5">
                      <li>
                        <Link className="group relative font-medium flex items-center gap-2.5 rounded-md ease-in-out duration-300 px-4 text-bodydark2 hover:text-white" href="form-elements.html">Form Elements</Link>
                      </li>
                      <li>
                        <Link className="group relative font-medium flex items-center gap-2.5 rounded-md ease-in-out duration-300 px-4 text-bodydark2 hover:text-white" href="form-layout.html" >Form Layout</Link>
                      </li>
                    </ul>
                  </div>
                  {/* Dropdown Menu End */}
